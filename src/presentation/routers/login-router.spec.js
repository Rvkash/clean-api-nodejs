...
describe('Login Router', () => {
  ...
  test('Should return 500 if AuthUseCase has no auth metod', async () => {
    const sut = new LoginRouter({})
    const httpRequest = {
      body: {
        email: 'any_@mail.com',
  ...
  test('Should return 500 if no Invalid method', async () => {
    const authUseCaseSpy = makeAuthUseCase()
    const sut = new LoginRouter(authUseCaseSpy, {})
    const httpRequest = {
      body: {
  ...
  test('Should call EmailValidator with correctemail', async () => {
    const { sut, emailValidatorSpy } = makeSut()
    const httpRequest = {
      body: {
        email: 'any_email@mail.com',
